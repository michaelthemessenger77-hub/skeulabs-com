    ...
    <section id="pricing" className="relative py-24 md:py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="mt-20 grid gap-6 lg:grid-cols-3">
            ...
            <div className="glass-card rounded-3xl overflow-hidden h-full">
              ...
              >
                ...
                <p className="mt-3 text-sm text-muted-foreground">
                  Professional landing page built for your business in 48 hours.
                </p>
                  ...
                  <div className="border-t border-white/10 p-8">
                    <div className="grid gap-6 md:grid-cols-2">
                      ...
                      <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
                        ...
                        <a
                          href="https://buy.stripe.com/00w28t1M33uD5FR5Ij2sM00"
                          target="_blank"
                      ...
                      <div className="rounded-2xl border border-[#D4AF37]/30 bg-[#D4AF37]/5 p-6">
                        ...
                        <a
                          href="https://buy.stripe.com/5kQdRbbmD7KTfgr7Qr2sM01"
                          target="_blank"
                          rel="noopener noreferrer"
          ...
          {/* Card 2 — Julia AI Receptionist (Most Popular) */}
          <AnimatedSection animation="fade-up" delay={150}>
            <div className="relative pt-5 h-full">
              {/* Most Popular Badge — outside overflow-hidden container */}
            ...
            <div className="glass-card rounded-3xl overflow-hidden h-full border-[#D4AF37]/40 glow-gold">

              {/* Collapsed Header */}
              <button
                onClick={() => toggleCard("julia")}
                className="w-full p-8 pt-10 text-left transition-colors hover:bg-white/5"
              >
                ...
                <p className="mt-3 text-sm text-muted-foreground">
                  Julia answers every call 24/7. Never miss a lead again.
                </p>
                <p className="mt-3 text-sm text-[#D4AF37]/80 italic">
                  Property management? Ask about our per-property pricing.
                </p>
                <div className="mt-4 flex items-center gap-2 text-sm font-medium text-[#D4AF37]">
                  See plans
                  <ChevronDown className={cn(
                    "h-4 w-4 transition-transform duration-300",
                    expandedCard === "julia" && "rotate-180"
                  )} />
                </div>
              </button>
                  ...
                  <div className="border-t border-white/10 p-8">
                    ...
                    <div className="mb-6 rounded-lg bg-white/5 border border-white/10 px-4 py-3 text-center">
                      <span className="text-sm text-muted-foreground">
                        $750 one-time setup for all plans
                      </span>
                    </div>
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                      ...
                      <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
                        ...
                        <a
                          href="https://buy.stripe.com/dRmfZj2Q7aX51pB3Ab2sM02"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="mt-6 w-full h-10 font-semibold inline-flex items-center justify-center rounded-md text-sm transition-colors border border-[#D4AF37]/30 text-foreground hover:bg-[#D4AF37]/10"
                        >
                      ...
                      {/* Growth (Recommended) */}
                      <div className="rounded-2xl border border-[#D4AF37]/30 bg-[#D4AF37]/5 p-6 relative">
                        <span className="absolute -top-3 left-1/2 -translate-x-1/2 text-xs font-semibold px-3 py-1 rounded-full bg-[#D4AF37] text-[#050816]">
                          Recommended
                        </span>
                        ...
                        <a
                          href="https://buy.stripe.com/7sYcN7eyP1mv3xJ2w72sM03"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="mt-6 w-full h-10 font-semibold inline-flex items-center justify-center rounded-md text-sm transition-colors bg-[#D4AF37] text-[#050816] hover:bg-[#D4AF37]/90"
                        >
          ...
          <AnimatedSection animation="fade-up" delay={300}>
            <div className="glass-card rounded-3xl overflow-hidden h-full">
              ...
              >
                ...
                <p className="mt-3 text-sm text-muted-foreground">
                  Your website and Julia working together. The complete system.
                </p>
                <div className="mt-4 flex items-center gap-2 text-sm font-medium text-[#D4AF37]">
                  See plans
                  <ChevronDown className={cn(
                    "h-4 w-4 transition-transform duration-300",
                    expandedCard === "full" && "rotate-180"
                  )} />
                </div>
              </button>
                  ...
                  <div className="border-t border-white/10 p-8">
                    ...
                    <div className="mb-6 rounded-lg bg-white/5 border border-white/10 px-4 py-3 text-center">
                      <p className="text-sm text-muted-foreground">
                        $499 site + $750 Julia setup
                      </p>
                      <p className="text-xs text-muted-foreground/70 mt-1">
                        Then $99/mo support + your Julia plan
                      </p>
                    </div>
        ...
        <AnimatedSection animation="fade-up" delay={450} className="mt-12">
          <div className="text-center">
            ...
            <div className="mt-4 flex flex-wrap justify-center gap-3">
              <span className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-muted-foreground/60">
